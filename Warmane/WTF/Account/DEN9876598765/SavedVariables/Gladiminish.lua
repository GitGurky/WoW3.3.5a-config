...
GladiminishDB = {
	["profileKeys"] = {
		["Asummi - Blackrock [PvP only]"] = "Asummi - Blackrock [PvP only]",
		["Bloodstorm - Blackrock [PvP only]"] = "Bloodstorm - Blackrock [PvP only]",
		["Openchest - Blackrock [PvP only]"] = "Openchest - Blackrock [PvP only]",
		["Acumii - Blackrock [PvP only]"] = "Acumii - Blackrock [PvP only]",
		["Hotwiffe - Blackrock [PvP only]"] = "Hotwiffe - Blackrock [PvP only]",
		["Etanhunt - Blackrock [PvP only]"] = "Etanhunt - Blackrock [PvP only]",
